...
_C.MODEL.BACKBONE.PRETRAIN = True  # default True
# Pretrain model path
...
# if use CLassification layer
_C.MODEL.HEADS.CLS_ENABLE = True
...
_C.MODEL.LOSSES.CIRCLE.GAMMA = 128  #default 128
...
# AdaSP Loss options
_C.MODEL.LOSSES.ADASP = CN()
_C.MODEL.LOSSES.ADASP.SCALE = 1.0
_C.MODEL.LOSSES.ADASP.TEMP = 0.05
_C.MODEL.LOSSES.ADASP.TYPE = 'adasp'
...
# MS loss
_C.MODEL.LOSSES.MS = CN()
_C.MODEL.LOSSES.MS.SCALE_POS = 2.0
_C.MODEL.LOSSES.MS.SCALE_NEG = 40.0
_C.MODEL.LOSSES.MS.SCALE = 1.0

# EP Loss options
_C.MODEL.LOSSES.EP = CN()
_C.MODEL.LOSSES.EP.SCALE = 1.0

# ProxyAnchor Loss options
_C.MODEL.LOSSES.PROXYAN = CN()
_C.MODEL.LOSSES.PROXYAN.SCALE = 1.0

# multiNCE Loss options
_C.MODEL.LOSSES.MULTINCE = CN()
_C.MODEL.LOSSES.MULTINCE.SCALE = 1.0
