...
class VehicleID(ImageDataset):
    ...
    def __init__(self, root='', test_list='', **kwargs):
...
class SmallVehicleID(VehicleID):
    ...
    def __init__(self, root='', **kwargs):
        ...
        super(SmallVehicleID, self).__init__(self.root, self.test_list, **kwargs)
...
class MediumVehicleID(VehicleID):
    ...
    def __init__(self, root='', **kwargs):
        ...
        super(MediumVehicleID, self).__init__(self.root, self.test_list, **kwargs)
...
class LargeVehicleID(VehicleID):
    ...
    def __init__(self, root='', **kwargs):
        ...
        super(LargeVehicleID, self).__init__(self.root, self.test_list, **kwargs)
